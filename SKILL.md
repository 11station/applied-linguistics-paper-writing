...
license: MIT
tags: [Applied Linguistics, Second Language Acquisition, SLA, TESOL, EFL, ESL, SSCI, English Academic Writing, Literature Review, Research Methods, L2 Pronunciation, Multilingualism, L2 Writing, Motivation, AI-assisted Language Teaching, 去AI味]
...
description: >
  ...
  重点关注语音习得、多语习得、二语写作、学习动机、AI 辅助语言教学等方向。覆盖选题、研究问题、文献综述、理论框架、研究设计、语料/数据分析、英文论文润色、去 AI 痕迹、
...
优先支持以下方向的选题设计、文献综述、方法论描述、结果解释、英文润色、选刊和审稿人模拟：

- **语音习得 / L2 pronunciation**：关注声学指标、感知/产出任务、可懂度、重音、音段/超音段、反馈与训练效果
- **多语习得 / multilingualism**：关注跨语言影响、语言经历、身份、教育语境、双语/多语能力与社会文化维度
- **二语写作 / L2 writing**：关注写作发展、反馈、评分、语篇特征、EAP/ESP、AI 写作辅助和写作评估
- **动机 / motivation**：关注 L2 motivational self system、engagement、anxiety、willingness to communicate、identity 与课堂语境
...
- 语言风格参考 5.1 目标期刊池中的 applied linguistics / SLA / TESOL / CALL / writing / multilingualism 论文，而不是通用英语作文或营销式英文
